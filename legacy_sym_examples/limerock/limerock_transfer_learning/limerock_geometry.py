...
from compat.geometry_compat import Box, Channel, Parameter, Parameterization, Plane
...
class LimeRock(object):
    def __init__(self):
        ...
        stl_path = Path(__file__).resolve().parents[1] / "stl_files" / "limerock.stl"
        self._parse_file(str(stl_path))
