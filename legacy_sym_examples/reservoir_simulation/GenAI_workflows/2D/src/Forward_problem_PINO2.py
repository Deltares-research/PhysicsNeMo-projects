...
def main() -> None:
    ...
    parser.add_argument("--config-name", type=str, default="config_PINO_original")
    ...
    run_training_from_cfg(cfg, default_dim=2, workflow_name="Forward_problem_PINO2", scenario_name="GENAI_2D")
