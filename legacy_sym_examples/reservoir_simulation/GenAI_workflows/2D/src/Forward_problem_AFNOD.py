...
def main() -> None:
    ...
    parser.add_argument("--config-name", type=str, default="config_FNO")
    ...
    run_training_from_cfg(cfg, default_dim=2, workflow_name="Forward_problem_AFNOD", scenario_name="GENAI_2D")
